...
## Corpus Check
- 127 files · ~18,584 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 616 nodes · 860 edges · 59 communities (39 shown, 20 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `51099e0e`
...
### Community 1 - ".GetCourse"
Cohesion: 0.32
Nodes (5): CourseEndpoints, Guid, IEndpointRouteBuilder, IResult, Task
...
Cohesion: 0.06
Nodes (24): Api.Models, Api.Extensions, Api.Services, Api.Data, Api.DTOs, Api.Endpoints, AiDigestDto, NotificationDto (+16 more)

### Community 8 - "OpenRouterDigestService"
Cohesion: 0.07
Nodes (30): ChatCompletionChoice, ChatMessage, IConfiguration, IHttpClientFactory, ILoggerFactory, string, AiDigestEndpoints, Guid (+22 more)
...
### Community 14 - "Plugging into the shared shell"
Cohesion: 0.33
Nodes (5): 1. Use the design tokens, 2. Add your nginx route, 3. Add your service to docker-compose.yml, 4. Flip your tile live, Plugging into the shared shell

### Community 16 - "AppDbContext"
Cohesion: 0.09
Nodes (22): AppDbContext, DbSet, ModelBuilder, DbSeeder, Guid, NotificationPreferenceRequestDto, NotificationEndpoints, Guid (+14 more)
...
## Knowledge Gaps
- **156 isolated node(s):** `1. Use the design tokens`, `2. Add your nginx route`, `3. Add your service to docker-compose.yml`, `4. Flip your tile live`, `name` (+151 more)
...
- **Why does `AppDbContext` connect `AppDbContext` to `.GetCourse`, `TaskEntity`, `Api.Models`, `OpenRouterDigestService`, `TaskEndpoints`?**
...
- **What connects `1. Use the design tokens`, `2. Add your nginx route`, `3. Add your service to docker-compose.yml` to the rest of the system?**
