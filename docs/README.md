...
- [**Database & Migrations Guide**](development/database-and-migrations.md) — Per-service database isolation (EF Core SQLite plus Student 1's PostgreSQL container), migrations lifecycle, schema seeding, and queries.
...
- [**`student-4/README.md`**](../student-4/README.md) — Account microservice.
