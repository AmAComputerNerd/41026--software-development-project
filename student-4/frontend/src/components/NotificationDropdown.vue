...
.nb-notif-dropdown {
  ...
  background: var(--nb-color-bg, #f4ecd8);
  border: var(--nb-border-width-md, 3px) solid var(--nb-color-ink, #121212);
  box-shadow: var(--nb-shadow, 4px 4px 0px #121212);
}
...
.nb-notif-dropdown__item {
  border-bottom: var(--nb-border-width-sm, 1.5px) solid var(--nb-color-ink, #121212);
...
.nb-notif-dropdown__item--unread {
  border-left: var(--nb-border-width-md, 3px) solid var(--nb-color-accent-orange, #ff6b35);
  padding-left: var(--nb-space-2, 8px);
}

.nb-notif-dropdown__message {
  margin: 0 0 4px;
  color: var(--nb-color-ink, #121212);
  font-size: 13px;
  line-height: 1.4;
}
